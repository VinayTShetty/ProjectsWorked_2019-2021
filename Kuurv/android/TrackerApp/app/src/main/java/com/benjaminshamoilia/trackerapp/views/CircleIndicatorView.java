...
public class CircleIndicatorView extends View {
    ...
    private void init(Context context) {
        ...
        activeIndicatorPaint.setColor(ContextCompat.getColor(context, R.color.colorAppTheme));
        activeIndicatorPaint.setAntiAlias(true);
        inactiveIndicatorPaint = new Paint();
        inactiveIndicatorPaint.setColor(ContextCompat.getColor(context, R.color.colorWhite));
        inactiveIndicatorPaint.setAntiAlias(true);
        radius = getResources().getDimensionPixelSize(R.dimen._8sdp);
        size = radius * 2;
    }
