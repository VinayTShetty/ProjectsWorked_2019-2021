...
public class Doorbell extends AlertDialog.Builder {
    ...
    public Doorbell(MainActivity activity, long id, String privateKey) {
    ...
    private void buildView() {
        ...
        int padding = (int) this.mContext.getResources().getDimension(R.dimen._15sdp);
        ...
        this.mMessageField.setTextAppearance(this.mContext,R.style.MyEditTextBlack);
        ...
        this.mEmailField.setTextAppearance(this.mContext,R.style.MyEditTextBlack);
