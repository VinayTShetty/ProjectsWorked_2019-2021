...
public class FragmentAppIntro extends Fragment {
    ...
    public static FragmentAppIntro newInstance(VoAppIntro page) {
        ...
        FragmentAppIntro fragment = new FragmentAppIntro();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        onboarderView = inflater.inflate(R.layout.fragment_appintro, container, false);
